...
criterion_group!(
    ...
    bench_pythagorean_triplet_and_1000_triangle_euclid_for,
);
...
fn bench_pythagorean_triplet_and_1000_triangle_euclid_for(c: &mut Criterion) {
    c.bench_function("pythagorean_triplet_and_1000_triangle_euclid_for", |b| {
        b.iter(pythagorean_triplet_and_1000_triangle_euclid_for)
    });
}
