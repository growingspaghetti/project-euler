...
// 1.0 us
/// ```rust
/// use self::project_euler::m18::the_maximum_total_from_top_to_bottom_of_the_triangle_bottom_up_2;
/// assert_eq!(the_maximum_total_from_top_to_bottom_of_the_triangle_bottom_up_2(), 1074);
/// ```
pub fn the_maximum_total_from_top_to_bottom_of_the_triangle_bottom_up_2() -> u16 {
